...
COPY server_hotfix_v210.py /app/server.py
COPY cqyi87_profile.py /app/cqyi87_profile.py

RUN python3 -m py_compile /app/server_y1_v160.py /app/server_wrapper_v181.py /app/server_hotfix_v203.py /app/server.py /app/cqyi87_profile.py
